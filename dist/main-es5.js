...
/* harmony import */ var microsoft_adal_angular6__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! microsoft-adal-angular6 */ "./node_modules/microsoft-adal-angular6/fesm5/microsoft-adal-angular6.js");
...
var log = new _app_core__WEBPACK_IMPORTED_MODULE_9__["Logger"]('App');
var AppComponent = /** @class */ (function () {
    function AppComponent(adalService, router, activatedRoute, titleService, translateService, i18nService) {
    ...
    AppComponent.prototype.ngOnInit = function () {
        ...
        if (top !== self) {
            ...
            var onNavigationEnd = this.router.events.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["filter"])(function (event) { return event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_2__["NavigationEnd"]; }));
            ...
            Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["merge"])(this.translateService.onLangChange, onNavigationEnd)
                ...
                return route;
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["filter"])(function (route) { return route.outlet === 'primary'; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["switchMap"])(function (route) { return route.data; }), Object(_app_core__WEBPACK_IMPORTED_MODULE_9__["untilDestroyed"])(this))
...
/* harmony import */ var microsoft_adal_angular6__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! microsoft-adal-angular6 */ "./node_modules/microsoft-adal-angular6/fesm5/microsoft-adal-angular6.js");
...
var GraphComponent = /** @class */ (function () {
    function GraphComponent(apiService, shareData) {
        var _this = this;
        ...
        this.setRoot = function (data) {
            // console.log('data', data);
            _this.root = d3.hierarchy(data, function (d) {
                return d.children;
            });
        ...
        this.update = function (source) {
            ...
            var treeData = _this.treemap(_this.root);
            ...
            // ****************** Nodes section ***************************
            // Update the nodes...
            var node = _this.svg.selectAll('g.node').data(nodes, function (d) {
            ...
            // ****************** links section ***************************
            // Update the links...
            var link = _this.svg.selectAll('path.link').data(links, function (d) {
                return d.id;
            });
        ...
        this.handleChildren = function (d) {
            if (d.children) {
                d._children = d.children;
                d.children = null;
            }
        ...
        this.updateData = function (node, updatedData) {
            // console.log('update Data');
            // console.log('node', node);
            // console.log('New Node', node);
            _this.setRoot(updatedData);
            _this.update(_this.handleChildren(node));
        ...
        //   }
        // };
        this.findAndUpdate = function (d, child) {
            var dataSet = [
                {
                    name: 'XXX',
                    orgkey: 'dK018s401192829'
        ...
        this.click = function (d) {
            ...
            _this.loader = true;
            // dK468791727385
            _this.apiService.getChildren(d.data.orgkey).subscribe(function (data) {
                _this.loader = false;
                console.log('data', data);
                if (data && data['children']) {
                    ...
                    objectFound = _this.findAndUpdate(d, childrenFromApi);
                    console.log('objectFound', objectFound);
                    // this.treeData = objectFound;
                    _this.updateData(d, objectFound);
                }
            }, function (err) {
                _this.loader = false;
                console.log('err', err);
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(fb, apiService, router, shareData) {
        this.fb = fb;
        this.apiService = apiService;
        this.router = router;
        this.shareData = shareData;
    ...
    HomeComponent.prototype.showGraph = function (data) {
...
var HttpInterceptorHandler = /** @class */ (function () {
    ...
    HttpInterceptorHandler.ctorParameters = function () { return [
 ...
 */
var HTTP_DYNAMIC_INTERCEPTORS = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["InjectionToken"]('HTTP_DYNAMIC_INTERCEPTORS');
/**
 * Extends HttpClient with per request configuration using dynamic interceptors.
 */
var HttpService = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](HttpService, _super);
    function HttpService(httpHandler, injector, interceptors) {
        ...
        if (!_this.interceptors) {
            ...
            _this.interceptors = [
                _this.injector.get(_error_handler_interceptor__WEBPACK_IMPORTED_MODULE_3__["ErrorHandlerInterceptor"]),
                _this.injector.get(_token_interceptor__WEBPACK_IMPORTED_MODULE_5__["TokenInterceptor"])
            ];
        }
        return _this;
...
var TokenInterceptor = /** @class */ (function () {
    function TokenInterceptor(adalSvc, router // private toastr: ToastrService
    ) {
    ...
    TokenInterceptor.prototype.addTokenSendRequest = function (request, next) {
        var _this = this;
        var token = '';
        var TokenResource = '';
        ...
        return next.handle(request).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (e) {
            if (e.status === 401 && e.url && e.url.indexOf(TokenResource) >= 0) {
                return _this.adalSvc.acquireToken(TokenResource).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["share"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
                    // if (environment.toast) {
                    //   this.toastr.error(err.message, 'Request error');
                    // }
                    throw err;
                }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(function (a) {
                    return _this.addTokenSendRequest(request, next);
                }));
            }
            else {
                // if (environment.toast) {
                ...
                // }
                console.log('this.adalSv111c', _this.adalSvc);
                if (!_this.adalSvc.isAuthenticated) {
...
var I18nService = /** @class */ (function () {
    ...
    I18nService.prototype.getTranslation = function (key) {
    ...
    Logger.prototype.log = function (func, level, objects) {
        ...
        if (level <= Logger.level) {
            ...
            Logger.outputs.forEach(function (output) {
                return output.apply(output, tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"]([_this.source, level], objects));
            });
        }
    };
    /**
...
var RouteReusableStrategy = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](RouteReusableStrategy, _super);
...
}(_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouteReuseStrategy"]));
...
var HeaderComponent = /** @class */ (function () {
    function HeaderComponent(adalSvc) {
        this.adalSvc = adalSvc;
...
var ProfileImageComponent = /** @class */ (function () {
    ...
    ProfileImageComponent.prototype.showUserPicture = function () {
